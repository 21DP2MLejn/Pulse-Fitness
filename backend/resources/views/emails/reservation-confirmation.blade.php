...
<body>
    ...
    <div class="content">
        ...
        <p>Thank you for making a reservation at Pulse Fitness. Your spot has been secured for the following training session:</p>
        ...
        <div class="info">
            ...
            <p><strong>Trainer:</strong> {{ $reservation->trainingSession->trainer_name }}</p>
        </div>
        
        <p>We look forward to seeing you there! Please arrive 10-15 minutes before the session starts.</p>
